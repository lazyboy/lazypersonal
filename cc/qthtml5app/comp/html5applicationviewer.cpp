// checksum 0xeee1 version 0x7000a
/*
  The following claim should not be true if I fixed it correctly:
...
QString Html5ApplicationViewerPrivate::adjustPath(const QString &path)
{
    ...
    if (!QDir::isAbsolutePath(path)) {
        ...
        qDebug("App dir path: %s", apppath.toStdString().c_str());
        QString ret = QUrl::fromLocalFile(QCoreApplication::applicationDirPath() +
                                   QLatin1String("/../Resources/") + path).toString();
